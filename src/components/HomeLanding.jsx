        ...
        <div className='p-5'>
            <div className="bg-landing-svg bg-no-repeat bg-center bg-cover h-screen flex justify-between p-10 pt-36 rounded-3xl shadow-2xl">
                <div className='w-1/2 m-auto mt-7 ml-3'>
                    ...
                    <button onClick={handleButtonClick} className='bg-orange-700 text-white font-semibold rounded-md mt-5 pr-5 pl-5 p-3 inline-block mr-2 hover:bg-orange-900 duration-200'>
